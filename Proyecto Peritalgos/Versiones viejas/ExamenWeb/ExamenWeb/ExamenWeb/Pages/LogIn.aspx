            ...
            <table  width="450" border="0"  align="center">
                ...
                <tr>
                    <td rowspan="5" class="style4" id="padlock"> 
                        &nbsp;
                        <img alt="" src="../Images/login.png" class="imagen-login" />
                    </td>
                ...
                <tr>
                    ...
                    <td align="right" class="style8" id="go">
                        <asp:ImageButton ID="image" ImageUrl="~/Images/acceder.png"
                            runat="server" onclick="btnLogIn_Click" Height="35px" Width="125px" TabIndex="4" />
                    </td>
                </tr>
                 <tr>
                    <td colspan="3" width="120">
